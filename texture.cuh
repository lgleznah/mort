...
struct checker_texture {
	public:
		...
		// The code in the current MRE never goes through this function. However, replacing the body of this
		// function with a "return color(0.0, 0.0, 0.0)" removes the behaviour
		__device__
...
void texturesToDevice(checker_texture* checkers, image_texture* images) {
