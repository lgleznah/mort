...
__global__ void setup_rng(curandState* states, unsigned long seed, int image_width) {
...
__device__ float random_float(curandState* states, int idx) {
...
__device__ float random_float(curandState* states, int idx, float min, float max) {
